      ...
      <div className="bg-white">
        <div className="max-w-[1100px] mx-auto p-4">
          <div className="flex flex-col bg-white mt-24 mb-24 space-y-24 w-full items-center md:flex-row md:space-y-0">
            <div className="bg-gray-100 m-4 pt-16 p-4 rounded-md flex flex-col items-center justify-center align-middle relative shadow hover:border-orange-500 border w-full">
              <Image
